<template>
  ...
  >
    <div class="container mx-auto px-5">
      <div class="wrapper">
        <h1 class="font-bold sm:text-3xl text-2xl mb-5">
        ...
        >
          <div
            class="box rounded-3xl flex flex-col gap-3"
            :class="{
              'bg-[#12111F]': navbar.userNav,
              'bg-white': !navbar.userNav,
            }"
            ...
            <h2 id="accordion-collapse-heading-1">
              ...
              >
                <span class="sm:text-base text-sm"
                  ...
                  Commodi voluptatum optio, totam tenetur impedit eius
