            ...
            <div class=" rounded-3xl flex flex-col items-center">
                <div class="box flex items-center justify-between rounded-3xl w-full p-5">
                    <div class="flex items-center gap-5">
                        <img class="sm:w-20 sm:h-20 w-40 h-40" src="/user.png" alt="">
                        <div class="flex flex-col gap-1">
                            <h2 class="sm:text-3xl font-bold">John Doe</h2>
                            <a
                                class="flex items-center gap-1 sm:text-sm font-medium hover:underline cursor-pointer hover:text-[#4ec3e0]">
                                johndoe@gmail.com
                            </a>
                        </div>
                    </div>
                    <button class="flex items-center gap-1 border px-7 py-3 text-base rounded-full border-[#4ec3e0] text-[#4ec3e0] hover:bg-[#4ec3e0] hover:text-white">
                ...
                <div class="border-b border-[#4ec3e0] w-full mt-5 flex items-center justify-center gap-20 pb-3">
                    <div class="flex flex-wrap items-center gap-5">
                        <button @click="active = 'videos'" :id="active == 'videos' ? 'active' : ''"
                            ...
                            class="border px-7 py-3 text-2xl rounded-full hover:border-[#4ec3e0] hover:text-[#4ec3e0]">
