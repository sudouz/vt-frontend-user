            ...
            <div class="z-10 w-full bg-transparent border border-[#4ec3e0] rounded-lg md:mt-0 sm:max-w-md xl:p-0"
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" @submit.prevent="useLogin" action="#">
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium ">To'liq (F . I . O)
                                kiriting</label>
                            <input v-model="user.full_name" type="name" name="name" id="name"
                                class="border text-sm rounded-lg outline-none block w-full p-2.5 bg-transparent border-[#4ec3e0]  placeholder-gray-400 "
                                placeholder="John Doe" required="" />
                        </div>
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium ">Elektron manzil
                                kiriting</label>
                        ...
                        <div>
                            <label for="password" class="block mb-2 text-sm font-medium">Parol kiriting</label>
                        ...
                        <div>
                            <label for="password_confirm" class="block mb-2 text-sm font-medium">Parolni tastiqlang</label>
                            <input v-model="user.password" type="password" name="password" id="password_confirm"
                                placeholder="••••••••"
                                class="border outline-none text-sm rounded-lg block w-full p-2.5 bg-transparent border-[#4ec3e0] placeholder-gray-400"
                                required="" />
                        </div>
                        ...
                        <span class="flex sm:flex-row flex-col items-center gap-1 justify-center text-sm">Shaxsiy
                            kabinetingiz bormi
                            <router-link to="/login" class="text-[#4ec3e0] hover:underline">Kirish
                            </router-link>
                        </span>
                    </form>
                </div>
